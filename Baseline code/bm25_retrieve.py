...
def load_data(source_path) -> dict['int', 'str']:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--question_path', type=str, required=False, help='讀取發布題目路徑', default='../data/dataset/preliminary/questions_example.json')  # 問題文件的路徑
    parser.add_argument('--source_path', type=str, required=False, help='讀取參考資料路徑', default='../data/reference')  # 參考資料的路徑
    parser.add_argument('--output_path', type=str, required=False, help='輸出符合參賽格式的答案路徑', default='../data/dataset/preliminary/pred_retrieve.json')  # 答案輸出的路徑
